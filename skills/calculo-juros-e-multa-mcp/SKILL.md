---
name: calculo-juros-e-multa-mcp
description: Cálculo de juros e multa: aplique juros simples ou compostos, multa e correção oficial sobre valores em atraso. Use quando o usuário pedir juros de mora, multa contratual ou o total atualizado de uma dívida em atraso.
---

# Cálculo de Juros e Multa — REST API skill

Você tem acesso à **Cálculo de Juros e Multa** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_calculo-juros-e-multa` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
