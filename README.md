...
### Juros, multa e correção sobre valores em atraso, para IA

**Cálculo de juros e multa** para IA. Aplique juros simples ou compostos, multa e correção oficial sobre qualquer valor em atraso, com índices ao vivo do BACEN e IBGE. Sem login.

- ⏱️ **Juros e multa** sobre valores em atraso, simples ou compostos
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Cálculo de Juros e Multa` e **URL** `https://api.mcp.ai/p_calculo-juros-e-multa`.

### Cursor

[➕ Instalar Cálculo de Juros e Multa no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=calculojurosemulta&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF9jYWxjdWxvLWp1cm9zLWUtbXVsdGEifQ==)

### VS Code (Copilot Chat)

[➕ Instalar Cálculo de Juros e Multa no VS Code](vscode:mcp/install?name=calculojurosemulta&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_calculo-juros-e-multa%22%7D)
...
```
Calcule juros de 1% ao mês + multa de 2% sobre R$ 5.000 em atraso há 8 meses
Some correção pelo IPCA e juros de mora sobre esta dívida
```
...
- 📧 [calculojurosemulta@mcp.ai](mailto:calculojurosemulta@mcp.ai)
- 🐛 [GitHub Issues](https://github.com/mcp-dir/calculo-juros-e-multa-mcp/issues)
- 📄 [docs/](docs/)
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_calculo-juros-e-multa` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
